...
<div class="panel panel-default">
    ...
    <div class="panel-body">
		...
		<form:form id="group-form" method="post">
		   ...
		   <div>
		   <p style="color:red">照片</p>
		   <img src="<woo:url value="/static/picture/${picname}"/>"  width="120px" height="100px" >
		   </div>
    </div>
</div>
    ...
    $('#group-form').bootstrapValidator({
        ...
        submitHandler: function(form) {
        	var datas = $("#group-form").toJson();
         	$.post(" <c:url value='/portal/admin/comment/update' />", datas, function(resp){
         		if (resp.r == 1){
         			$.dialog({
         				title: "提示",
         			    content: "保存成功！"
