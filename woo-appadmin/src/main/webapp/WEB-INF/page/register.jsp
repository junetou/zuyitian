            ...
            <div class="col-md-4 col-md-offset-4" >
                <div class="login-panel panel panel-default" style="background-color:#FFFFCC; " >
                    ...
                    <div class="panel-body">
                        <form action="<c:url value='/register/createofregister'/>" method="post">
                            <fieldset>
                                <div class="form-group">
                                	<input id="usrname" type="text" class="form-control" name="usrname" placeholder="登陆账户(英文加数字)"  required autofocus/>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input id="newpassword" type="password" class="form-control" name="newpassword" placeholder="再次确认密码" >
                                </div>
                                 
                                <div class="form-goup">
                                    <input id="name" type="text" class="form-control" name="name" placeholder="用户名" onclick="javascript:judgement()" requied>
                                </div>
                                <div class="form-group" style="color:#F00;">
									<span id="message">${error}</span> 
								</div>
                                <input type="submit" class="btn btn-lg btn-success btn-block" tabindex="3" onclick="regist()"  value="注册"/>
